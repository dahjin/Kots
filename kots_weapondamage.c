...
int Kots_CharacterShotgunDamage(edict_t *ent, int damage)
{
	...
	case 0:
		return Kots_CharacterMunitionDamage(ent, damage);
	case 1:
		return Kots_CharacterMunitionDamage(ent, 6);
	case 2:
...
int Kots_CharacterGrenadeDamage(edict_t *ent, int damage)
{
	...
	case 6:
		return Kots_CharacterMunitionDamage(ent, 375);
	default: // > 6
		if (ent->character->cur_grenade >= 10 && ent->character->rune && ent->character->rune->grenade > 0)
			return Kots_CharacterMunitionDamagePlus(ent, 450, ent->character->cur_grenade);
		else
			return Kots_CharacterMunitionDamagePlus(ent, 375, ent->character->cur_grenade);
	}
}
...
int Kots_CharacterRailgunDamage(edict_t *ent, int damage)
{
	...
	case 6:
		return Kots_CharacterMunitionDamage(ent, 275);
	default: // > 6
		return Kots_CharacterMunitionDamagePlus(ent, 275, ent->character->cur_railgun);
	}
}
